...
p.maxw = 10;      %Default maximum window size for near peak regions; default is 10
...
for q = 1:nct  %FOR each cell trace
    ...
    [pks, vls] = ct_getpeaks(dt, p.narm, ppass{:},'SMOOTH',5); %default no SMOOTH parameter
...
%REDUCE_EMPTIES (subfunction, recursive)
